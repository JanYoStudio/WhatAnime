...
class MainRecyclerAdapter(private val context: Context) :
    ...
    override fun setItemView(binding: ItemSearchResultBinding, position: Int, data: Docs) {
        ...
        val nativeTitle =
            "${context.getString(R.string.hint_title_native)}${data.title_native ?: ""}"
        val chineseTitle =
            "${context.getString(R.string.hint_title_chinese)}${data.title_chinese ?: ""}"
        val englishTitle =
            "${context.getString(R.string.hint_title_english)}${data.title_english ?: ""}"
        val romajiTitle =
            "${context.getString(R.string.hint_title_romaji)}${data.title_romaji ?: ""}"
